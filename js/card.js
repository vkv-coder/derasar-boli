...
<style>
  *{box-sizing:border-box;margin:0;padding:0}
  ...
  .vc-logo-wrap{width:20%;flex-shrink:0;margin-left:10px;background-color:#fdf6e8;background-image:url('${logoUrl}');background-repeat:no-repeat;background-position:center center;background-size:contain}
  ...
  .vc-member-count{font-size:10px;color:#666;font-weight:700}
  .vc-front-right{width:60px;flex-shrink:0;display:flex;flex-direction:column;align-items:center;justify-content:center;padding:4px}
  #qr-canvas{width:52px !important;height:52px !important;display:block;margin:0 auto}
...
<script>
  ...
  QRCode.toCanvas(document.getElementById('qr-canvas'), CARD_URL, { width: 140, margin: 1, color: { dark: '#000000', light: '#fdf6e8' } }, function(err) {});
