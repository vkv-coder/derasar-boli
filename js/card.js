...
<style>
  *{box-sizing:border-box;margin:0;padding:0}
  ...
  .vc-logo-wrap{width:20%;flex-shrink:0;margin-left:10px;background-color:#fff;background-image:url('${logoUrl}');background-repeat:no-repeat;background-position:center center;background-size:contain}
